  ...
  return (
    <div className="flex flex-col gap-6 px-4 py-4 animate-pulse">
      ...
      <div className="overflow-auto w-full">
        <div className="min-w-full border border-default-200 rounded-lg overflow-hidden">
          <div className="flex bg-gray-100 dark:bg-zinc-800 text-sm font-semibold">
            {Array.from({ length: 5 }).map((_, idx) => (
              <div key={idx} className="flex-1 px-4 py-3 bg-gray-200 dark:bg-zinc-700 h-6 rounded mx-1"></div>
            ))}
          </div>
